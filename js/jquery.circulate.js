    ...
    $.circulate = function(el, options) {
        ...
        base.runAnimation = function() {
            ...
            if (base.options.keepGoing) {
                ...
                base.$el.animate({
                    top: ["+=" + (base.options.height / 2) + "rem", 'easeInQuad'],
                    left: ["+=" + (base.options.width / 2) + "rem", 'easeOutQuad'],
                ...
                .animate({
                    top: ["+=" + (base.options.height / 2) + "rem", 'easeOutQuad'],
                    left: ["-=" + (base.options.width / 2) + "rem", 'easeInQuad'],
